...
def find_favorite(array_of_hash_objects)
  ...
  # array_of_hash_objects.each_with_index do |h,i|
  #   found_index = i if h[:is_my_favorite?] == true
  # end

  # (found_index) ? found_hash = array_of_hash_objects[found_index] : found_hash
  array_of_hash_objects.find { |h| h[:is_my_favorite?] == true }
end
